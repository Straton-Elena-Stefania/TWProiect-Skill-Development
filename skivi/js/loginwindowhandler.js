...
function toggleRegisterWindow() {
    ...
    if (!mql.matches) {
        signUpBoxDesign.style.transform = "scale(100%, 120%)";
    } else {
        signUpBoxDesign.style.transform = "scale(60%, 80%)";
    }
...
function toggleLoginWindow() {
    ...
    newdiv.style.flexDirection = "column";
    if (!mql.matches) {
        signUpBoxsignUpBoxDesign.style.transform = "scale(100%, 100%)";
    } else {
        signUpBoxsignUpBoxDesign.style.transform = "scale(60%, 60%)";
    }
    newdiv.style.justifyContent = "center";
