...
<%@ page import="com.timetraveling.models.users.UserDAO" %>
        ...
        <div class="sectionMenu">
            ...
            <div class="imageContainer">
                <div class="skillContainerUpperBar">
                    <button id="timeTravelFavoriteButton" class="heartSkillButton">
            ...
            <div class="imageContainer">
                <div class="skillContainerUpperBar">
                    <button id="firstAidFavoriteButton" class="heartSkillButton">
                        <i class="fa fa-heart-o"></i>
                    </button>
                    <span class="floatingFavoritedText">Added to favorite skills</span>
                    <button class="removeSkillButton modalWindowOpener" data-modal="skillRemovalWarningModal">
            ...
            <div class="imageContainer">
                <div class="skillContainerUpperBar">
                    <button id="cookingFavoriteButton" class="heartSkillButton">
                        <i class="fa fa-heart-o"></i>
                    </button>
                    <span class="floatingFavoritedText">Added to favorite skills</span>
                    <button class="removeSkillButton modalWindowOpener" data-modal="skillRemovalWarningModal">
